    ...
    <div className="navbar items-center  bg-base-100 shadow-md rounded-2xl top-0 sticky z-40">
      ...
      <div className="navbar-end">
        {/* <label className="swap swap-rotate">
          ...
          <svg
            className="swap-off h-6 w-6 md:h-9 md:w-9 mr-2 fill-current"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
          >
          ...
          <svg
            className="swap-on h-6 w-6 md:h-9 md:w-9 mr-2 fill-current"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
          >
        ...
        {/* Show Sign In/Register only on large screen here */}
        {!user && (
          <div className=" lg:flex">
            <NavLink
              to="/signin"
              className="btn btn-sm md:btn-md hover:bg-[#CAEB66] p-2 mr-0.5 md:mr-2 "
            >
              Sign In
            </NavLink>
            <NavLink
